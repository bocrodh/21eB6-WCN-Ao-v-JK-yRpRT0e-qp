...
filtered = st.multiselect("Filter fields", options=df_selection.columns, default=df_selection["BB Number", "Relative Position of Canada","Links with domestic Payments Modernization work"])
